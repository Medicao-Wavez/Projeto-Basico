...
O cronograma de todas as atividades está paltado nos prazos que devem ser seguidos para a implantação do processo de medição. Este cronograma pode sofrer alterações durante a execução do processo de medição, e deve ser validado com as partes interessadas no processo, tal como a empresa que utilizará o plano, e a equipe que irá implantar o plano.
